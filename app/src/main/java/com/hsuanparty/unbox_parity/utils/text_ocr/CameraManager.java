...
public final class CameraManager {
    ...
    public synchronized void openDriver(SurfaceHolder holder) throws IOException {
        ...
        configManager.initRotation(camera);
     ...
     */
    public com.hsuanparty.unbox_parity.utils.text_ocr.PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height) {
