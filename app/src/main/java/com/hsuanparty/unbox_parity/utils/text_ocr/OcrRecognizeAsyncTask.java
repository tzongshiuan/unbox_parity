...
final class OcrRecognizeAsyncTask extends AsyncTask<Void, Void, Boolean> {
    ...
    OcrRecognizeAsyncTask(ScanFragment fragment, TessBaseAPI baseApi, byte[] data, int width, int height) {
    ...
    protected Boolean doInBackground(Void... arg0) {
        ...
        Bitmap bitmap = fragment.getCameraManager().buildLuminanceSource(data, width, height).renderCroppedGreyscaleBitmap();
        String textResult;
